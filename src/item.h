...
menu->addAction (QIcon(QPixmap(ScriptExtender::actionlist.at(i).icon)), ScriptExtender::actionlist.at(i).text, this,ScriptExtender::actionlist.at(i).slot.toLatin1().data());}}
...
public slots:	
	...
	virtual QString getType()const{return QString("World");}
