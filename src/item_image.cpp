...
void Item_image::load(const QString& filename){
...
void Item_image::subImage(Item_texture *tex, int xTexOfs,int yTexOfs, int width, int height, int xImgOfs, int yImgofs){
