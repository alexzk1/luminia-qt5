...
namespace CEBError
{
    ...
    protected:
        ...
        //----------------------------------------------------------------------------
        const char *generateMsg(const std::string& _msg) const
        {
    ...
    public:
        ...
        /// @param [in] _path the location of the file
        //----------------------------------------------------------------------------
        fileError(QString _path)
        {
            m_txt = std::move(_path);
        }
        //----------------------------------------------------------------------------
        /// @brief returns an explanatory string
        //----------------------------------------------------------------------------
    ...
    public:
        ...
        /// @param [in] _path the location of the file
        //----------------------------------------------------------------------------
        openGlError(QString _type, QString _msg)
        {
    ...
    public:
        ...
        {
            m_errMsg = std::move(_errMsg);
            m_program = std::move(_prog);
        }
        //----------------------------------------------------------------------------
        /// @brief returns an explanatory string
        //----------------------------------------------------------------------------
