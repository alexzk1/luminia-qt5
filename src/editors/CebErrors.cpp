...
namespace CEBRaise
{
    ...
    void QtFileError(QFileDevice::FileError _e, const QString& _path)
    {
        switch (_e)
        {
            ...
            {
                throw CEBError::fileRenameError(_path);
                break;
            }
            case QFileDevice::PositionError:
            {
                throw CEBError::filePositionError(_path);
                break;
            }
            case QFileDevice::ResizeError:
            {
                throw CEBError::fileResizeError(_path);
                break;
            }
            case QFileDevice::PermissionsError:
            {
                throw CEBError::filePermissionsError(_path);
                break;
            }
            case QFileDevice::CopyError:
            {
                throw CEBError::fileCopyError(_path);
                break;
            }
            default:
            {
