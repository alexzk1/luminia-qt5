...
#pragma pack()
    ...
    void process_triangular_mesh(){
        ...
        while ( stop_pos > file->pos()){
            ...
            switch(chunk.id){
                case 0x4110:
                    process_vertex_list(first_vertex); break;
                case 0x4120:
                    process_face_description(first_vertex); break;
                case 0x4140:
                    process_texcoords(first_vertex); break;
                default:
                    qDebug() << "Unknown chunk" << (void*)chunk.id;
