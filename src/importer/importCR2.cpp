                                                            ...
                                                            if (tag == "parent")
                                                                ...
                                                                if (tag == "smartparent")
                                                                    ...
                                                                    if (tag == "inkyParent")
                                                                        ...
                                                                        if (tag == "nonInkyParent")
                                                                            in >> a.nonInkyParent >> endl;
                                                                        else
                                                                            if (tag == "conformingTarget")
