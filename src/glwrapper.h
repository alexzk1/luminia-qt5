...
public slots:
    ...
    QObject* Shader(const QString& vertex, const QString& fragment);

    QObject* Shader(QObject* inVertex);
    QObject* Shader(const QString& vertex);

    QObject* Shader(QObject* inVertex, QObject* inGeometric, QObject* inFragment, int inPrimitive, int outPrimitive, int outVertices);
    QObject* Shader(const QString& vertex, const QString& geometric, const QString& fragment, int inPrimitive, int outPrimitive, int outVertices);

    QObject* Shader(QObject* inVertex, QObject* inGeometric, int inPrimitive, int outPrimitive, int outVertices);
    QObject* Shader(const QString& vertex, const QString& geometric, int inPrimitive, int outPrimitive, int outVertices);
